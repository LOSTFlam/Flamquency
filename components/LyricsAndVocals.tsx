...
const LyricsAndVocals: React.FC = () => {
      ...
      <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar">
        ...
        <div className="space-y-4">
            ...
            <div>
             ...
             <div>
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Structure</label>
                <select 
                    value={structure}
                    onChange={(e) => setStructure(e.target.value)}
                    className="w-full bg-daw-800 border border-daw-600 rounded p-2 text-sm focus:border-daw-accent outline-none"
                >
                    <option>Verse - Chorus - Verse - Chorus - Bridge - Outro</option>
