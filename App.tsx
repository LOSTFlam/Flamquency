...
const AppContent: FC = () => {
  ...
  const renderContent = () => {
    switch (mode) {
      case AppMode.ARRANGER:
        return <Arranger onChangeMode={setMode} />;
  ...
  return (
    <div className="flex h-screen w-screen bg-daw-900 text-gray-200 overflow-hidden font-sans selection:bg-daw-accent selection:text-white flex-col">
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar Navigation */}
        <aside className="w-20 md:w-64 bg-daw-900 border-r border-daw-800 flex flex-col shrink-0 z-20 shadow-xl relative">
            ...
            <nav className="flex-1 py-6 space-y-2 px-2 overflow-y-auto">
                ...
                />
                 <NavItem 
                    active={mode === AppMode.ARRANGER} 
                    onClick={() => setMode(AppMode.ARRANGER)} 
        ...
        {/* Main Content Area */}
        <main className="flex-1 bg-daw-900 overflow-hidden relative flex flex-col">
    ...
    return (
        <div className="h-full overflow-y-auto p-8 custom-scrollbar">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
                <DashboardCard 
                    title="Arranger View" 
                    desc="Timeline view of your full track. Manage clips and structure."
                    color="bg-indigo-600"
                    onClick={() => onSelect(AppMode.ARRANGER)}
                />
                <DashboardCard 
